...
#By default the standard deduction for 1 individual in 2017 ($6350) is set as the deduction in the second argument, but can be changed. 
...
#Define function
single_tax2017 <- function(gi, deduct = 6350) {
